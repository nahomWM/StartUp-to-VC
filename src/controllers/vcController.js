...
exports.updateMe = catchAsync(async (req, res, next) => {
    ...
    const filteredBody = filterObj(req.body, 'profile', 'location', 'investmentCriteria');

    // 2) Update VC document
    const vc = await vcService.updateMe(req.user.id, filteredBody);
